...
HD_PWD='D:/OpalFolder/MyOwnProject/FPGA/GALS_System1/GALS_System1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gals_top_mpmc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gals_top_mpmc.tcl
