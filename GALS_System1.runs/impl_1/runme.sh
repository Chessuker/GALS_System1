...
HD_PWD='D:/OpalFolder/MyOwnProject/FPGA/GALS_System1/GALS_System1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gals_top_mpmc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gals_top_mpmc.tcl -notrace
