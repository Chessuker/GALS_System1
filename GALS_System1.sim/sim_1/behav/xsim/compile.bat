...
REM
REM Generated by Vivado on Sat Apr 18 21:31:00 +0700 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_gals_mpmc_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_gals_mpmc_vlog.prj -log xvlog.log
